...
%IF VARIABLES ARE SAVED JUST LOAD AND PLOT FROM HERE - SPECIFY PART, PHASES
...
% oot=1; %COUNTER TO GENERATE ALL NIFTIES IN A SINGLE RUN 
% while oot < 6;
for pa = 1:part
for phase = 1:phases
...
%CREATE AND PLOT AS MONTAGE
%GENERATE FINALIM FROM THE IMAGE YOU WANT TO PLOT IE, FOUR, FT_LC_180...
%CHOOSE REDUCED REGION TO PLOT
%CREATE AVI
