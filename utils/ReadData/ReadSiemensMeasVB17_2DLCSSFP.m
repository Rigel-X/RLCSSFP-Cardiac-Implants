function [first, second, third, fourth, rawdata,newraw,loopcounters,sMDH,lc_names] = ReadSiemensMeasVB17_2DLCSSFP(measfile, dispopt)
...
%for rep=1:1,%sMDH.sLC.ushRepetition,%7
  ...
  lc;
    ...
    lin_idx = find(loopcounters(:,1) == lc & loopcounters(:,7) == measure & loopcounters(:,6) == phase & loopcounters(:,15) == coil & loopcounters(:,16) == sMDH.ushSamplesInScan); 
